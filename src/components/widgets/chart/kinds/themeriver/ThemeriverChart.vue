...
import { themeriverOption } from './option'
...
const { toPng } = useEChart(rootEl, () => themeriverOption(props.chart, isDark()), () => props.chart)
</script>

<template>
  <ChartCard :title="title" @png="toPng(title || 'themeriver')">
