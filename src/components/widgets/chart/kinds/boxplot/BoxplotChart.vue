...
import { boxplotOption } from './option'
...
const { toPng } = useEChart(rootEl, () => boxplotOption(props.chart, isDark()), () => props.chart)
</script>

<template>
  <ChartCard :title="title" @png="toPng(title || 'boxplot')">
