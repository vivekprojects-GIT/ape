...
import { parallelOption } from './option'
...
const { toPng } = useEChart(rootEl, () => parallelOption(props.chart, isDark()), () => props.chart)
</script>

<template>
  <ChartCard :title="title" @png="toPng(title || 'parallel')">
