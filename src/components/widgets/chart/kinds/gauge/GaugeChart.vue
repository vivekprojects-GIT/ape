...
import { gaugeOption } from './option'
...
const { toPng } = useEChart(rootEl, () => gaugeOption(props.chart, isDark(), props.title), () => props.chart)
</script>

<template>
  <ChartCard :title="title" @png="toPng(title || 'gauge')">
