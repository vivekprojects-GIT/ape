...
import { heatmapOption } from './option'
...
const { toPng } = useEChart(rootEl, () => heatmapOption(props.chart, isDark()), () => props.chart)
</script>

<template>
  <ChartCard :title="title" @png="toPng(title || 'heatmap')">
